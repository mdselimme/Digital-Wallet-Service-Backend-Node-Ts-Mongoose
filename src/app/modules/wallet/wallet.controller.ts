...
const getSingleWallet = catchAsyncTryCatchHandler(async (req: Request, res: Response) => {
...
// Get All Wallet Data For admin 
const getMyWallet = catchAsyncTryCatchHandler(async (req: Request, res: Response) => {
